...
import { Calendar, Clock, Edit, Eye, MoreVertical, Package, TrendingDown, TrendingUp } from "lucide-react"
...
import { PaymentStatusButton } from "@/modules/home/order/ui/table/payment-status-button";
import { OrderStatusButton } from "@/modules/home/order/ui/table/return-status-button";
...
export const MobileOrderView = ({ orders }: Props) => {
    ...
    return (
        <div className="w-full md:hidden space-y-4 bg-gray-900">
