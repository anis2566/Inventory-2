...
export const PaymentStatusAdminModal = () => {
    const { isOpen, onClose, status, orderId } = usePaymentStatusAdmin()
    ...
    const { mutate: updateStatus, isPending } = useMutation(trpc.order.paymentStatus.mutationOptions({
        onError: (error) => {
                                        ...
                                        <SelectContent>
                                            {
                                                Object.values(PAYMENT_STATUS).map((status) => (
                                                    <SelectItem key={status} value={status} className={cn("", status === PAYMENT_STATUS.Received && "hidden")}>{status}</SelectItem>
                                                ))
                                            }
                                        </SelectContent>
                                    </Select>
