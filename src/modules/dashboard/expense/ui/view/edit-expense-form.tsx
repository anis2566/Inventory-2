...
export const EditExpenseForm = ({ id }: Props) => {
    ...
    const { mutate: updateExpense, isPending } = useMutation(
        trpc.expense.updateOne.mutationOptions({
            onError: (error) => {
            ...
            onSuccess: (data) => {
                ...
                queryClient.invalidateQueries(trpc.expense.getOne.queryOptions({ id }));
    ...
    const form = useForm<ExpenseSchemaType>({
        ...
        defaultValues: {
            type: data?.type as EXPENSE_TYPE || "",
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Customize your expense information</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
